# SSB Agent MCP - Intelligent Norwegian Statistics System
...
### Azure OpenAI Setup
You need access to Azure OpenAI with o3-mini deployment:

1. **Azure OpenAI Resource** with API access
2. **o3-mini Model Deployment** (for reasoning capabilities)
3. **API Credentials** (key, endpoint, deployment name)
...
```bash
# Population queries
python ssb_agent_mcp.py "befolkning Bergen 2024"
python ssb_agent_mcp.py "Compare Oslo and Stavanger population"

# Employment queries
python ssb_agent_mcp.py "Hvor mange jobber i hver næring i norge?"
python ssb_agent_mcp.py "unemployment statistics by region"

# Education queries
python ssb_agent_mcp.py "utdanning nivå befolkning fylke"
python ssb_agent_mcp.py "education statistics Norway"

# Housing queries
python ssb_agent_mcp.py "boligpriser utvikling siste år"
python ssb_agent_mcp.py "housing prices trend municipalities"

# Healthcare queries  
python ssb_agent_mcp.py "helse tjenester kapasitet"
python ssb_agent_mcp.py "hospital capacity statistics"

# Any other domain
python ssb_agent_mcp.py "transport statistikk kollektiv"
python ssb_agent_mcp.py "environmental data pollution"
```

### Example Output

The system provides structured, intelligent responses:

```
🧠 o3-mini Reasoning Model Analysis

🔧 Calling: search_tables_advanced
 query        befolkning Bergen 2024
 
📤 search_tables_advanced Result:
🔍 Found 5 tables for query: 'befolkning Bergen 2024'
[Table results with relevance scores]

🔧 Calling: analyze_table_structure
 table_id     11342
 
📤 analyze_table_structure Result:
📊 Table Analysis: 11342
Title: Areal og befolkning i kommuner, fylker og hele landet (K) 2007-2025
[Dimension structure revealed]

🔧 Calling: discover_dimension_values  
 dimension_name  region
 
📤 discover_dimension_values Result:
❌ Error: Dimension 'region' not found
💡 Suggestion: Use one of: ['Region', 'ContentsCode', 'Tid']

🔧 Calling: discover_dimension_values
 dimension_name  Region    [LEARNED PATTERN: region → Region]
 search_term     Bergen
 
📤 discover_dimension_values Result:
✅ Found Bergen: code "4601", label "Bergen"

🔧 Calling: get_filtered_data
 filters         {"Region": "4601", "ContentsCode": "Folkemengde", "Tid": "2024"}
 
📤 get_filtered_data Result:
📈 Data Retrieved: Bergen population 2024: 291,940 persons
```
...
This project provides access to Statistics Norway's public data under Creative Commons CC0 Public Domain license. The code follows standard open-source practices.

## Support

- **SSB Data**: [Official SSB API Documentation](https://www.ssb.no/api)
- **Azure OpenAI**: Azure OpenAI service documentation
- **OpenAI Agents SDK**: [OpenAI Agents MCP Guide](https://openai.github.io/openai-agents-js/guides/mcp/)
- **System Issues**: Create an issue in the project repository
